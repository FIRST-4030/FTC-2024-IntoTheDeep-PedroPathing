...
public class TurnTuner extends OpMode {
    ...
    public void init() {
        ...
        Constants.setConstants(fConstants.getClass(), lConstants.getClass());        poseUpdater = new PoseUpdater(hardwareMap);

        dashboardPoseTracker = new DashboardPoseTracker(poseUpdater);

        telemetryA = new MultipleTelemetry(this.telemetry, FtcDashboard.getInstance().getTelemetry());
        telemetryA.addLine("Turn your robot " + Math.toDegrees(ANGLE) + " degrees. Your turn ticks to inches will be shown on the telemetry.");
        telemetryA.update();
